package fanzone.datacollection.fragment;
...
import fanzone.datacollection.activity.PostDetailActivity;
import fanzone.datacollection.models.Post;
import fanzone.datacollection.models.Posts;
import fanzone.datacollection.viewholder.PostViewHolder;
...
public abstract class PostListFragment extends Fragment {
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        mAdapter = new FirebaseRecyclerAdapter<Posts, PostViewHolder>(Posts.class, R.layout.item_post,
            ...
            protected void populateViewHolder(final PostViewHolder viewHolder, final Posts model, final int position) {
                ...
                viewHolder.bindToPost(model, new View.OnClickListener() {
                    ...
                    public void onClick(View starView) {
                        ...
                        DatabaseReference globalPostRef = mDatabase.child("FAN").child(postRef.getKey());
